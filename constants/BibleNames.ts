...
export const BIBLE_NAMES = [
  // Homens do Antigo Testamento (AT_Homens)
  ...
  { name: 'Adão', color: '#E67E22', rgb: [230, 126, 34], category: 'AT_Homens' },
  { name: 'Abel', color: '#95A5A6', rgb: [149, 165, 166], category: 'AT_Homens' },
  { name: 'Caim', color: '#D35400', rgb: [211, 84, 0], category: 'AT_Homens' },
  { name: 'Josué', color: '#1ABC9C', rgb: [26, 188, 156], category: 'AT_Homens' },
  { name: 'Calebe', color: '#3498DB', rgb: [52, 152, 219], category: 'AT_Homens' },
  { name: 'Gideão', color: '#9B59B6', rgb: [155, 89, 182], category: 'AT_Homens' },
  { name: 'Samuel', color: '#E74C3C', rgb: [231, 76, 60], category: 'AT_Homens' },
  { name: 'Jeremias', color: '#F1C40F', rgb: [241, 196, 15], category: 'AT_Homens' },
  { name: 'Daniel', color: '#2ECC71', rgb: [46, 204, 113], category: 'AT_Homens' },
  { name: 'Isaías', color: '#E67E22', rgb: [230, 126, 34], category: 'AT_Homens' },
  { name: 'Jonas', color: '#3498DB', rgb: [52, 152, 219], category: 'AT_Homens' },
  { name: 'Jônatas', color: '#16A085', rgb: [22, 160, 133], category: 'AT_Homens' },
  { name: 'Benjamim', color: '#FF6B6B', rgb: [255, 107, 107], category: 'AT_Homens' },
  { name: 'Judá', color: '#FF8C00', rgb: [255, 140, 0], category: 'AT_Homens' },
  { name: 'Rúben', color: '#27AE60', rgb: [39, 174, 96], category: 'AT_Homens' },

  // Mulheres do Antigo Testamento (AT_Mulheres)
  ...
  { name: 'Sara', color: '#FF69B4', rgb: [255, 105, 180], category: 'AT_Mulheres' },
  { name: 'Eva', color: '#FFC0CB', rgb: [255, 192, 203], category: 'AT_Mulheres' },
  { name: 'Abigail', color: '#FF1493', rgb: [255, 20, 147], category: 'AT_Mulheres' },
  { name: 'Ana', color: '#DB7093', rgb: [219, 112, 147], category: 'AT_Mulheres' },
  { name: 'Débora', color: '#FF6347', rgb: [255, 99, 71], category: 'AT_Mulheres' },
  { name: 'Miriam', color: '#FF8C00', rgb: [255, 140, 0], category: 'AT_Mulheres' },
  { name: 'Joquebede', color: '#CD5C5C', rgb: [205, 92, 92], category: 'AT_Mulheres' },
  { name: 'Agar', color: '#C71585', rgb: [199, 21, 133], category: 'AT_Mulheres' },

  // Homens do Novo Testamento (NT_Homens)
  ...
  { name: 'Estevão', color: '#4682B4', rgb: [70, 130, 180], category: 'NT_Homens' },
  { name: 'Barnabé', color: '#20B2AA', rgb: [32, 178, 170], category: 'NT_Homens' },
  { name: 'Silas', color: '#556B2F', rgb: [85, 107, 47], category: 'NT_Homens' },
  { name: 'Gabriel', color: '#9370DB', rgb: [147, 112, 219], category: 'NT_Homens' },

  // Mulheres do Novo Testamento (NT_Mulheres)
  ...
  { name: 'Isabel', color: '#FF1493', rgb: [255, 20, 147], category: 'NT_Mulheres' },
  { name: 'Lídia', color: '#DB7093', rgb: [219, 112, 147], category: 'NT_Mulheres' },
  { name: 'Priscila', color: '#FF6347', rgb: [255, 99, 71], category: 'NT_Mulheres' },
  { name: 'Dorcas', color: '#E91E63', rgb: [233, 30, 99], category: 'NT_Mulheres' },
  { name: 'Febe', color: '#FF69B4', rgb: [255, 105, 180], category: 'NT_Mulheres' },
];
